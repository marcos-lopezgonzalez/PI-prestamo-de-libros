...
<body class="min-h-screen bg-slate-100 ">
    ...
    <main class="max-w-6xl mx-auto px-4 py-12">
        <h1 class="text-2xl font-bold text-slate-800 mb-2">Libros prestados</h1>
        <p class="text-sm text-slate-600 mb-8">
            Solo se muestran libros que has prestado a otros usuarios
        </p>
        <?php
        $libros = librosPrestados($_SESSION["username"]);
