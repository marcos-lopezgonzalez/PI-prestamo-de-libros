...
<body class="min-h-screen bg-slate-100">
    ...
    <main class="max-w-6xl mx-auto px-4 py-12">
        <h1 class="text-2xl font-bold text-slate-800 mb-2">Libros recibidos</h1>
        <p class="text-sm text-slate-600 mb-8">
            Solo se muestran libros que has pedido prestados
        </p>
        <?php
        $libros = librosRecibidos($_SESSION["username"]);
